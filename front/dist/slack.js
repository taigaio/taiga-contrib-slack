...
(function() {
  ...
  module.run([
    '$templateCache', function($templateCache) {
      return $templateCache.put('contrib/slack', '<div contrib-slack-webhooks="contrib-slack-webhooks" ng-controller="ContribSlackAdminController as ctrl"><header><h1 tg-main-title="tg-main-title"></h1></header><form><label for="url">Slack webhook url</label><div class="contrib-form-wrapper"><fieldset class="contrib-input"><input type="text" name="url" ng-model="slackhook.url" placeholder="Slack webhook url" id="url" data-type="url"/></fieldset><fieldset ng-show="slackhook.id" class="contrib-test"><a href="" title="Test" ng-click="ctrl.testHook()" class="button-gray"><span>Test</span></a></fieldset></div><label for="channel">Slack webhook channel</label><div class="contrib-form-wrapper"><fieldset class="contrib-input"><input type="text" name="channel" ng-model="slackhook.channel" placeholder="#slackchannel" id="channel"/></fieldset></div><button type="submit" class="hidden"></button><a href="" title="Save" ng-click="ctrl.updateOrCreateHook(slackhook)" class="button-green submit-button"><span>Save</span></a></form><a href="https://taiga.io/support/slack-integration/" target="_blank" class="help-button"><span class="icon icon-help"></span><span>Do you need help? Check out our support page!</span></a></div>');
    }
  ]);
